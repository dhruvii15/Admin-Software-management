...
const DashWeb = () => {
    ...
    const getData = () => {
        setLoading(true);
        axios.post('http://localhost:5005/api/plexus/portfolio/read/admin')
            .then((res) => {
    ...
    const getData2 = () => {
        setLoading(true);
        axios.post('http://localhost:5005/api/plexus/culture/read')
            .then((res) => {
    ...
    const getData3 = () => {
        setLoading(true);
        axios.get('http://localhost:5005/api/plexus/position/read')
            .then((res) => {
    ...
    const getAdminData = () => {
        axios.get('http://localhost:5005/api/plexus/admin/read')
            .then((res) => {
    ...
    const handleToggle = async () => {
        ...
        try {
            const response = await axios.patch(`http://localhost:5005/api/plexus/admin/update/${adminId}`, { hiringStatus: newState });
