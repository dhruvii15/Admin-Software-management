...
const Intern = () => {
    ...
    const getData = async (page = 1) => {
        try {
            ...
            const response = await axios.get('http://localhost:5004/api/plexus/employee/intern/read');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const endpoint = id
                ? `http://localhost:5004/api/plexus/employee/intern/update/${id}`
                : 'http://localhost:5004/api/plexus/employee/intern/create';
    ...
    const handleDelete = async (id) => {
        if (!isSubmitting && window.confirm("Are you sure you want to delete this intern?")) {
            try {
                setIsSubmitting(true);
                // Replace with your intern API endpoint
                const response = await axios.delete(`http://localhost:5004/api/plexus/employee/intern/delete/${id}`);
