...
// assets
import logoDark from "../../assest/logo.svg";
import login from "../../assest/lock.png";
    ...
    <div className="bg-[#EFF3FF] p-10 h-screen flex items-center justify-center">
      <div className="bg-white p-6 md:p-10 rounded-3xl shadow-lg w-full h-full flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2">
          <img src={logoDark} alt="Logo" className="mb-15 w-40" />
            ...
            <div className="bg-white p-6 rounded-lg">
              <Formik
                ...
                onSubmit={async (values, { setErrors, setSubmitting }) => {
                  setLoading(true);
                  try {
                    const response = await axios.post('https://api.pslink.world/api/plexus/admin/login', {
                      email: values.email,
                      pass: values.pass
                    });
                ...
                {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                  <form noValidate onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className="w-full bg-[#0777AB] text-white font-semibold py-2 rounded-lg transition"
                    >
        ...
        {/* Right Side - Image */}
        <div className="hidden md:flex md:w-1/2 items-center justify-center rounded-lg bg-gray-100">
          <img src={login} alt="Login" className="max-w-[700px]" />
        </div>
      </div>
    </div>
  );
